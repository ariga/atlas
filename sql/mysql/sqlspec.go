...
var TypeRegistry = types.NewRegistry(
	...
	types.WithSpecs(
		...
		types.TypeSpec(TypeBool),
		types.TypeSpec(TypeBoolean),
		types.TypeSpec(TypeBit, types.WithAttributes(types.SizeTypeAttr(false))),
		types.TypeSpec(TypeInt, types.WithAttributes(unsignedTypeAttr(), types.SizeTypeAttr(false))),
		types.TypeSpec(TypeTinyInt, types.WithAttributes(unsignedTypeAttr(), types.SizeTypeAttr(false))),
		types.TypeSpec(TypeSmallInt, types.WithAttributes(unsignedTypeAttr(), types.SizeTypeAttr(false))),
		types.TypeSpec(TypeMediumInt, types.WithAttributes(unsignedTypeAttr(), types.SizeTypeAttr(false))),
		types.TypeSpec(TypeBigInt, types.WithAttributes(unsignedTypeAttr(), types.SizeTypeAttr(false))),
		types.TypeSpec(TypeDecimal, types.WithAttributes(unsignedTypeAttr(), &schemaspec.TypeAttr{Name: "precision", Kind: reflect.Int, Required: false}, &schemaspec.TypeAttr{Name: "scale", Kind: reflect.Int, Required: false})),
		types.TypeSpec(TypeNumeric, types.WithAttributes(unsignedTypeAttr(), &schemaspec.TypeAttr{Name: "precision", Kind: reflect.Int, Required: false}, &schemaspec.TypeAttr{Name: "scale", Kind: reflect.Int, Required: false})),
		types.TypeSpec(TypeFloat, types.WithAttributes(unsignedTypeAttr(), &schemaspec.TypeAttr{Name: "precision", Kind: reflect.Int, Required: false}, &schemaspec.TypeAttr{Name: "scale", Kind: reflect.Int, Required: false})),
		types.TypeSpec(TypeDouble, types.WithAttributes(unsignedTypeAttr(), &schemaspec.TypeAttr{Name: "precision", Kind: reflect.Int, Required: false}, &schemaspec.TypeAttr{Name: "scale", Kind: reflect.Int, Required: false})),
		types.TypeSpec(TypeReal, types.WithAttributes(unsignedTypeAttr(), &schemaspec.TypeAttr{Name: "precision", Kind: reflect.Int, Required: false}, &schemaspec.TypeAttr{Name: "scale", Kind: reflect.Int, Required: false})),
		types.TypeSpec(TypeTimestamp, types.WithAttributes(&schemaspec.TypeAttr{Name: "precision", Kind: reflect.Int, Required: false})),
		types.TypeSpec(TypeDate, types.WithAttributes(&schemaspec.TypeAttr{Name: "precision", Kind: reflect.Int, Required: false})),
		types.TypeSpec(TypeTime, types.WithAttributes(&schemaspec.TypeAttr{Name: "precision", Kind: reflect.Int, Required: false})),
		types.TypeSpec(TypeDateTime, types.WithAttributes(&schemaspec.TypeAttr{Name: "precision", Kind: reflect.Int, Required: false})),
		types.TypeSpec(TypeYear, types.WithAttributes(&schemaspec.TypeAttr{Name: "precision", Kind: reflect.Int, Required: false})),
		types.TypeSpec(TypeVarchar, types.WithAttributes(types.SizeTypeAttr(true))),
		types.TypeSpec(TypeChar, types.WithAttributes(types.SizeTypeAttr(false))),
		types.TypeSpec(TypeVarBinary, types.WithAttributes(types.SizeTypeAttr(false))),
		types.TypeSpec(TypeBinary, types.WithAttributes(types.SizeTypeAttr(false))),
		types.TypeSpec(TypeBlob, types.WithAttributes(types.SizeTypeAttr(false))),
		types.TypeSpec(TypeTinyBlob),
		types.TypeSpec(TypeMediumBlob),
		types.TypeSpec(TypeLongBlob),
		types.TypeSpec(TypeJSON),
		types.TypeSpec(TypeText, types.WithAttributes(types.SizeTypeAttr(false))),
		types.TypeSpec(TypeTinyText),
		types.TypeSpec(TypeMediumText),
		types.TypeSpec(TypeLongText),
		types.TypeSpec(TypeGeometry),
		types.TypeSpec(TypePoint),
		types.TypeSpec(TypeMultiPoint),
		types.TypeSpec(TypeLineString),
		types.TypeSpec(TypeMultiLineString),
		types.TypeSpec(TypePolygon),
		types.TypeSpec(TypeMultiPolygon),
		types.TypeSpec(TypeGeometryCollection),
	),
)
