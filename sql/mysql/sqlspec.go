...
var TypeRegistry = types.NewRegistry(
	...
	types.WithSpecs(
		...
		types.Spec(TypeBit, types.WithAttributes(types.SizeTypeAttr(false))),
		types.Spec(TypeInt, types.WithAttributes(unsignedTypeAttr(), types.SizeTypeAttr(false))),
		types.Spec(TypeTinyInt, types.WithAttributes(unsignedTypeAttr(), types.SizeTypeAttr(false))),
		types.Spec(TypeSmallInt, types.WithAttributes(unsignedTypeAttr(), types.SizeTypeAttr(false))),
		types.Spec(TypeMediumInt, types.WithAttributes(unsignedTypeAttr(), types.SizeTypeAttr(false))),
		types.Spec(TypeBigInt, types.WithAttributes(unsignedTypeAttr(), types.SizeTypeAttr(false))),
		types.Spec(TypeDecimal, types.WithAttributes(unsignedTypeAttr(), &schemaspec.TypeAttr{Name: "precision", Kind: reflect.Int, Required: false}, &schemaspec.TypeAttr{Name: "scale", Kind: reflect.Int, Required: false})),
		types.Spec(TypeNumeric, types.WithAttributes(unsignedTypeAttr(), &schemaspec.TypeAttr{Name: "precision", Kind: reflect.Int, Required: false}, &schemaspec.TypeAttr{Name: "scale", Kind: reflect.Int, Required: false})),
		types.Spec(TypeFloat, types.WithAttributes(unsignedTypeAttr(), &schemaspec.TypeAttr{Name: "precision", Kind: reflect.Int, Required: false}, &schemaspec.TypeAttr{Name: "scale", Kind: reflect.Int, Required: false})),
		types.Spec(TypeDouble, types.WithAttributes(unsignedTypeAttr(), &schemaspec.TypeAttr{Name: "precision", Kind: reflect.Int, Required: false}, &schemaspec.TypeAttr{Name: "scale", Kind: reflect.Int, Required: false})),
		types.Spec(TypeReal, types.WithAttributes(unsignedTypeAttr(), &schemaspec.TypeAttr{Name: "precision", Kind: reflect.Int, Required: false}, &schemaspec.TypeAttr{Name: "scale", Kind: reflect.Int, Required: false})),
		types.Spec(TypeTimestamp, types.WithAttributes(&schemaspec.TypeAttr{Name: "precision", Kind: reflect.Int, Required: false})),
		types.Spec(TypeDate, types.WithAttributes(&schemaspec.TypeAttr{Name: "precision", Kind: reflect.Int, Required: false})),
		types.Spec(TypeTime, types.WithAttributes(&schemaspec.TypeAttr{Name: "precision", Kind: reflect.Int, Required: false})),
		types.Spec(TypeDateTime, types.WithAttributes(&schemaspec.TypeAttr{Name: "precision", Kind: reflect.Int, Required: false})),
		types.Spec(TypeYear, types.WithAttributes(&schemaspec.TypeAttr{Name: "precision", Kind: reflect.Int, Required: false})),
		types.Spec(TypeVarchar, types.WithAttributes(types.SizeTypeAttr(true))),
		types.Spec(TypeChar, types.WithAttributes(types.SizeTypeAttr(false))),
		types.Spec(TypeVarBinary, types.WithAttributes(types.SizeTypeAttr(false))),
		types.Spec(TypeBinary, types.WithAttributes(types.SizeTypeAttr(false))),
		types.Spec(TypeBlob, types.WithAttributes(types.SizeTypeAttr(false))),
		types.Spec(TypeTinyBlob),
		types.Spec(TypeMediumBlob),
		types.Spec(TypeLongBlob),
		types.Spec(TypeJSON),
		types.Spec(TypeText, types.WithAttributes(types.SizeTypeAttr(false))),
		types.Spec(TypeTinyText),
		types.Spec(TypeMediumText),
		types.Spec(TypeLongText),
		types.Spec(TypeGeometry),
		types.Spec(TypePoint),
		types.Spec(TypeMultiPoint),
		types.Spec(TypeLineString),
		types.Spec(TypeMultiLineString),
		types.Spec(TypePolygon),
		types.Spec(TypeMultiPolygon),
		types.Spec(TypeGeometryCollection),
	),
)
