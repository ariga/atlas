...
| [ariga/atlas-push-action](https://github.com/ariga/atlas-push-action)   | Push your migration directory to Atlas Cloud (atlasgo.cloud) |
...
## `ariga/atlas-push-action`

You can use [ariga/atlas-push-action](https://github.com/ariga/atlas-push-action) to sync your
migration directory from your GitHub repository to [Atlas Cloud](https://atlasgo.cloud).

Use this action in your workflow to push your migration directory to Atlas Cloud.
...
jobs:
  push:
    ...
    steps:
      - uses: actions/checkout@v3
      - uses: ariga/atlas-push-action@v0
        with:
          name: dir_name
          dir: path/to/migrations
