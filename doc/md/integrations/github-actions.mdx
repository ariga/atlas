...
You can use [ariga/atlas-action/migrate-apply](/ariga/atlas-action/blob/master/migrate/apply/action.yml) to deploy migrations to your database directly from
GitHub Actions.
