...
| [ariga/atlas-action/migrate/down](https://github.com/ariga/atlas-action/tree/master/migrate/down/action.yml) | Revert migrations to a database    |
| [ariga/atlas-action/migrate/test](https://github.com/ariga/atlas-action/tree/master/migrate/test/action.yml) | Test migrations on a database    |
| [ariga/atlas-action/schema/test](https://github.com/ariga/atlas-action/tree/master/schema/test/action.yml) | Test schema on a database    |
    ...
    steps:
      ...
      - uses: ariga/atlas-action/migrate/down@v1
        with:
          ...
          dev-url: "postgres://postgres:pass@localhost:5432/dev"
          amount: 1
```
    ...
    steps:
      ...
      - uses: ariga/atlas-action/migrate/down@v1
        with:
          ...
          dev-url: "sqlite://file2?mode=memory&_fk=1"
          amount: 1
```
</TabItem>
<TabItem value="sqlserver">
    ...
    steps:
      ...
      - uses: ariga/atlas-action/migrate/down@v1
        with:
          ...
          dev-url: "sqlserver://sa:P@ssw0rd0995@localhost:1433?database=dev"
          amount: 1
```
    ...
    steps:
      ...
      - uses: ariga/atlas-action/migrate/down@v1
        with:
          ...
          dev-url: "clickhouse://root:pass@localhost:9000/dev"
          amount: 1
```
