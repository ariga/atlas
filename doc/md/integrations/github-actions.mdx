...
| [ariga/setup-atlas](https://github.com/ariga/set-uatlas) | Install Atlas from a Github Action    |
...
The [ariga/setup-atlas](https://github.com/ariga/setup-atlas) action can be used to install Atlas from a github action.
...
The action supports the `Version` input:
