...
:::info <a class="sticky-anchor" id={"scope"} href={"#testing-views"}>Testing Views</a>
...
:::info LOGIN REQUIRED
Event Triggers are currently available to logged-in users only. To use this feature, run:
```
atlas login
```
:::
...
:::info <a class="sticky-anchor" id={"scope"} href={"#testing-functions"}>Testing Functions</a>
