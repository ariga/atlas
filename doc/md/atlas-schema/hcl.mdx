...
Atlas testing framework allows you to write unit tests for your procedures. The following example demonstrates how
to write tests for a stored procedure `check_user_email` that checks a user's email. For more detail, read the [schema testing docs](/testing/schema)
