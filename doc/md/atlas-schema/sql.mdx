...
[Atlas HCL](/knowledge/ddl.md#hcl) syntax, it is easy to compose documents describing the desired
...
disambiguated by using resource [qualifers](/knowledge/ddl.md#qualifiers). The following document describes a
