...
### Boolean
The `boolean` and `bool` type allows creating standard SQL boolean columns.
...
### Binary
The `binary_varying`, `varbinary` and `varbyte` type allows creating binary string columns.
