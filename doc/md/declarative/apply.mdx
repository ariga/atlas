...
:::info Login to Atlas
By default, running `atlas schema apply` applies only **schemas**, **tables**, and their associated **indexes** and
...
and additional beta features are available to [Atlas Pro users](/features#pro-plan). To include these resources in schema migrations, use
