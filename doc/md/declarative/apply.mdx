...
of figuring our the correct SQL statements to get their database to the desired schema,
...
normalization. That is, despite us providing some specific definition of some
aspect of the schema, the database will store it in another, equivalent form.
This means in some situations it may appear to Atlas as if some diff exists
...
that will be used to normalize the schema prior to planning migrations and
