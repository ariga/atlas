...
slug: /declarative/mysql-declarative-sql
---
...
:::info
In this article, we will be focusing on SQL-based schema inspection with Atlas. For those opting to use HCL schema, please refer to the documentation [here](https://atlasgo.io/declarative/mysql-declarative-hcl).
:::
