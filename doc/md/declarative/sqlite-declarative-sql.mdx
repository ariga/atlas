---
id: sqlite-declarative-sql
title: Getting started with SQL declarative migrations for an SQLite schema
slug: /declarative/sqlite-declarative-sql
---
...
:::info
In this article, we will be focusing on SQL-based schema inspection with Atlas. For those opting to use an HCL schema, read the documentation [here](https://atlasgo.io/declarative/sqlite-declarative-hcl).
:::
