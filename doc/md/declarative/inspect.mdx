...
in all commands that are supported by Atlas DDL. To output the schema in SQL format, use the `--log` flag as follows:

```shell
atlas schema inspect -u "mysql://localhost" --log "{{ sql . }}"
```
...
schema. Visit [gh.ariga.cloud/explore](https://gh.ariga.cloud/explore) and follow the instructions.

<p style={{textAlign: "center"}}><a href="https://gh.ariga.cloud/explore/0083bc5b"><img src="https://atlasgo.io/uploads/images/atlas-erd-screenshot.jpg" alt="Schema ERD"/></a></p>
