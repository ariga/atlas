...
slug: /declarative/sqlite-declarative-hcl
---
...
Once SQLite is installed, you can connect to the create a database server using the statement below in terminal:
...
--url "sqlite://example.db" > schema.hcl
```
...
:::info
In this article, we will be focusing on HCL-based schema inspection with Atlas. For those opting to use SQL schema, refer to the documentation [here](https://atlasgo.io/declarative/sqlite-declarative-sql).
:::
