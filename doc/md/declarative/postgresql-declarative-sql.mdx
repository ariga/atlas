...
slug: /declarative/postgresql-declarative-sql
---
...
:::info
In this article, we will be focusing on SQL-based schema inspection with Atlas. For those opting to use an HCL schema, read the documentation [here](https://atlasgo.io/declarative/postgresql-declarative-hcl).
:::
