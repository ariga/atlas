...
Around 1% of Atlas users use the open-source version, if you wish to obtain a build of
Atlas built purely the open-source code base, follow the instructions in the [Community Edition](/community-edition)
page.
...
All common open-source RDMBS are supported in all versions of Atlas. In addition, Atlas also supports SQL Server and ClickHouse in the Free Plan of Atlas Cloud.
