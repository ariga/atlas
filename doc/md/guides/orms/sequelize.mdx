...
Make sure all you Node dependencies are installed by running:
```bash
npm install
```
...
* **Standalone** - If all of your Sequelize models exist in single directory,
 you can use the provider directly to load your Sequelize schema into Atlas.
* **Script** - In other cases, you can use the provider as a npm package to write a script
