...
Using the provider does not require connecting to the database.
...
For example, if you are adding GenerationType.SEQUENCE to the Event entity, you will need to add an insert statements to your generated migration file:
