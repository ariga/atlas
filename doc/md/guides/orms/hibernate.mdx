...
:::note
We currently do not support using generated fields using strategies that require data initialization such as GenerationType.SEQUENCE or GenerationType.TABLE and Generation.AUTO.
Atlas currently does not support data migrations, but it's in our roadmap.
...
to make sure to apply the ignored statements.
:::
...
* **Gradle Task** - In most cases, you can use the provider as a Gradle task to output
...
Hibernate or if you are not using Gradle, you can use the provider as a library and create
