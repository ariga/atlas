...
[CI/CD pipelines](http://localhost:3000/guides/modern-database-ci-cd) more easily:
...
<TabItem value="js" label="JavaScript" default>
<Tabs>
<TabItem value="task" label="Blog.js" default>
...
<TabItem value="ts" label="TypeScript">
<Tabs>
<TabItem value="task" label="Blog.ts" default>
