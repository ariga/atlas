...
2\. In your GORM model, define a field that uses the data type provided by the extension. In this example, we use the
...
-- Create "users" table
CREATE TABLE "public"."users" ("id" bigserial NOT NULL, "created_at" timestamptz NULL, "updated_at" timestamptz NULL, "deleted_at" timestamptz NULL, PRIMARY KEY ("id"));
-- Create index "idx_users_deleted_at" to table: "users"
CREATE INDEX "idx_users_deleted_at" ON "public"."users" ("deleted_at");
-- Create "geometry_points" table
CREATE TABLE "public"."geometry_points" ("id" bigserial NOT NULL, "created_at" timestamptz NULL, "updated_at" timestamptz NULL, "deleted_at" timestamptz NULL, "x" numeric NULL, "y" numeric NULL, "user_id" bigint NULL, PRIMARY KEY ("id"), CONSTRAINT "fk_users_location" FOREIGN KEY ("user_id") REFERENCES "public"."users" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION);
-- Create index "idx_geometry_points_deleted_at" to table: "geometry_points"
CREATE INDEX "idx_geometry_points_deleted_at" ON "public"."geometry_points" ("deleted_at");
```
