...
-- Create "users" table
CREATE TABLE "public"."users" ("id" bigserial NOT NULL, "created_at" timestamptz NULL, "updated_at" timestamptz NULL, "deleted_at" timestamptz NULL, "tenant_id" bigint NULL, PRIMARY KEY ("id"));
...
CREATE TABLE "public"."tenants" ("id" bigserial NOT NULL, "created_at" timestamptz NULL, "updated_at" timestamptz NULL, "deleted_at" timestamptz NULL, "name" text NULL, "user_id" bigint NULL, PRIMARY KEY ("id"));
...
users1 := db.WithContext(ctx1).Find(&users1)
// Users1 can only see users from tenant a8m.
users2 := db.WithContext(ctx2).Find(&users2)
