...
This guide explains how to define a schema field type as a domain type in your GORM schema and configure the schema migration
to manage both the domains and the GORM schema as a single migration unit using Atlas.
...
The `models` package is mostly used for defining GORM types (objects) and logic. Domain types,
