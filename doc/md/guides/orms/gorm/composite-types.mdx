---
title: Using Composite Types in GORM Schema
id: composite-types
...
This guide explains how to define a schema field type as a composite type in your GORM schema and configure the schema migration
to manage both the composite types and the GORM schema as a single migration unit using Atlas.
...
To set up, follow along the [getting started guide](https://atlasgo.io/guides/orms/gorm) for GORM and Atlas.

## Composite Schema

The `models` package is mostly used for defining GORM types (objects) and logic. Composite types,
...
2\. In your GORM schema, define a field that uses the composite type only in PostgreSQL dialect:
...
`schema.sql` and your GORM schema:
...
CREATE TABLE "addresses" ("id" bigserial NOT NULL, "created_at" timestamptz NULL, "updated_at" timestamptz NULL, "deleted_at" timestamptz NULL, "street" text NULL, "city" text NULL, "user_id" bigint NULL, PRIMARY KEY ("id"), CONSTRAINT "fk_users_address" FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION);
