...
Atlas works in similar way to the Doctrine migration tool, by calculating the diff between the _current_ state of the database,
...
<Tabs>
<TabItem value="v3" label="Dcotrine DBAL v3" default>
...
<TabItem value="v4" label="Doctrine DBAL v4">
...
* **Script** - In other cases, or if you use a [Symfony](https://symfony.com/) project,
you can use the provider as a PHP script to load your Doctrine schema into Atlas.
...
print (DumpDDL(["./src/Entity"], "mysql")); // mariadb | postgres | sqlite | sqlserver
```
