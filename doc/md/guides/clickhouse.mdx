...
title: Automatic Migrations for ClickHouse with Atlas
...
If you are already using ClickHouse Cloud and want to inspect it, 
you can work with Atlas through [Url](../concepts/url) and utilize it throughout the guide.
```
