...
The declarative approach lets users manage schemas by defining the desired state. Atlas then safely alters the database
to match. Let's see this in action.
