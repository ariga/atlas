...
When you configure your Fly project, you can define a _release command_. This command is executed during the release phase, before the new version of your application is deployed.  If it fails, i.e exits with a status other than zero, Fly marks the deployment as failed mas well. The release command is the
