...
######################################################################## 100.0%
/builds/rotemtam/atlas-demo
atlas version v0.14.1-eb3661f-canary
https://github.com/ariga/atlas/releases/latest
Installation successful!
$ atlas login --token $ATLAS_CLOUD_TOKEN
You are now connected to "rotemtam85" on Atlas Cloud.
$ ATLAS_CONTEXT=$(cat <<EOF # collapsed multi-line command
$ atlas migrate lint --base atlas://gitlab -w --dev-url "sqlite://demo?mode=memory" --context "$ATLAS_CONTEXT"
// highlight-next-line
...
$ ATLAS_CONTEXT=$(cat <<EOF # collapsed multi-line command
$ echo $ATLAS_CONTEXT
{ "repo": "rotemtam/atlas-demo", "branch": "main", "commit": "65ee9f161dfab8698a1673f7ae0a588cd83784e1", "url": "https://gitlab.com/rotemtam/atlas-demo" }
$ atlas migrate push gitlab --dev-url "sqlite://demo?mode=memory" --context "$ATLAS_CONTEXT"
// highlight-next-line
