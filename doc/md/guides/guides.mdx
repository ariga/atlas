...
<div className="row">
  <Card
    name="Automatic Migrations for Redshift"
    description="This guide is for getting started with Redshift using Atlas"
    url="/guides/redshift"
    image={CardImage.Redshift}
  />
</div>
...
<div className="row">
  ...
  <Card
    name="Doctrine"
    description="Learn about automatic migration planning for Doctrine using Atlas"
    url="/guides/orms/doctrine"
    image={CardImage.Tools}
  /> 
  <Card
    name="Entity Framework Core"
    description="Learn about automatic migration planning for Entity Framework Core using Atlas"
    url="/guides/orms/efcore"
    image={CardImage.Tools}
  />
</div>
...
<div className="row">
  ...
  />
    <Card
        ...
        description="This guide is for writing and executing tests for database domains."
        url="/guides/testing/domains"
        image={CardImage.Testing}
    />
    <Card
        name="Testing Stored Procedures"
        description="This guide is for writing and executing tests for stored procedures."
        url="/guides/testing/procedures"
        image={CardImage.Testing}
    />    <Card
        name="Testing Triggers"
        description="This guide is for writing and executing tests for database triggers."
        url="/guides/testing/triggers"
        image={CardImage.Testing}
    />
</div>
