...
<div className="row">
  <Card
    name="Atlas with ArgoCd"
    description="Simplifying Database Management with Atlas Kubernetes Operator and Argo CD"
    url="/guides/argocd/integration"
    image={CardImage.Deployment}
  />
</div>
...
<div className="row">
  <Card
    ...
    url="/guides/cloud/explore-inspection"
    image={CardImage.Cloud}
  />
</div>
