...
* When the datbase is ready, Install Atlas on the GitHub Actions runner.
* With Atlas installed, use it to apply all existing migrations on this database prior to the tests running.
