...
slug: /getting-started/sqlite-declarative-sql
---
...
:::info
In this article, we will be focusing on SQL-based schema inspection with Atlas. For those opting to use an HCL schema, read the documentation [here](/getting-started/sqlite-declarative-hcl).
:::
