...
```shell
atlas schema inspect -u "maria://root:pass@localhost:3306/example" > atlas.hcl
```
...
```shell
atlas schema inspect -u "postgres://postgres:pass@localhost:5432/example?sslmode=disable" > atlas.hcl
```
...
```shell
atlas schema inspect -u "sqlite://file.db" > atlas.hcl
```
...
```shell
atlas schema apply -u "maria://root:pass@localhost:3306/example" -f atlas.hcl
```
...
```shell
atlas schema apply -u "postgres://postgres:pass@localhost:5432/example?sslmode=disable" -f atlas.hcl
```
...
```shell
atlas schema apply -u "sqlite://file.db" -f atlas.hcl
```
