...
Download the [latest release](https://release.ariga.io/atlas/atlas-windows-amd64-v0.3.0.exe) and
move the atlas binary to a file location on your system PATH.
...
If you would like to build Atlas from source without the UI follow the instructions [here](../cli.md#building-from-source).
