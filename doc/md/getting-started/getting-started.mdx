...
Now that we have our migration files ready, you can use the `migrate apply` command to apply the changes to the database.
To learn more about this process, check out the [Versioned Migrations Quickstart Guide](/versioned/intro)
