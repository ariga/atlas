...
:::info
Note, it is recommended to use the [`--dev-url`](../cli/dev-database) option when generated columns are used.
:::
...
:::info
Note, it is recommended to use the [`--dev-url`](../cli/dev-database) option when index expressions are used.
:::
...
:::info
Note, it is recommended to use the [`--dev-url`](../cli/dev-database) option when partial indexes are used.
:::
