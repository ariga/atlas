...
As of version v0.14.3 we no longer provide a windows binary. Windows users are advised to use our [docker
image](https://hub.docker.com/r/arigaio/atlas) or use [WSL](https://learn.microsoft.com/en-us/windows/wsl/install).
