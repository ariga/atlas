...
* **GitHub Action** (recommended) - Install the [`ariga/atlas-action`](https://github.com/ariga/atlas-action)
  ...
  more control on how to set it up, and what [Dev Database](/dev) to use (e.g, PostGIS) for linting, changes simulation, etc.
...
* **GitHub App** - Install the Atlas Cloud GitHub App on your GitHub repository. Atlas Cloud will automatically pull
  ...
  This workflow is faster to set up, but it does require that you have the necessary permissions to install the GitHub
