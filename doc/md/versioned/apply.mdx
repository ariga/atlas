...
migrations of the `app` service based on the most recent pushed state. To see it in action, run the following:
...
**Deploy** to a local database a remote migration directory named `app`:
<Tabs>
<TabItem value="postgres" label="PostgreSQL">
