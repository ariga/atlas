...
To apply a specific tag of your migration directory, add `?tag=<tag>` to the `--dir` URL. For example:

```shell
atlas migrate apply \
  --dir "file://migrations?tag=39e7e4e35fce7409bd26d25d8140061695d4ffd5" \
