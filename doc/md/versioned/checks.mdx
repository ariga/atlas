...
Pre-migration checks are available only to [Atlas Pro users](/features#pro). To use this feature, run:
```
atlas login
```
:::
...
![Check passed](https://atlasgo.io/uploads/cloud/deploy/check-passed-v1.png)
...
![Check failed](https://atlasgo.io/uploads/cloud/deploy/check-failed-v1.png)
