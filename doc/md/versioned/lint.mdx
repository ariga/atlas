...
The `--atlas:nolint` directive can be used at the file level to exclude the file from analysis, or to exclude specific
statements in the file from specific [checks](../lint/analyzers.md#checks) or analyzers.
