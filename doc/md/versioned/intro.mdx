...
directory to the Atlas Schema Registry, and applying changes to databases. For more in-depth guides, please check out the other pages in
...
the [Atlas Cloud Schema Registry](/cloud/features/registry), much like how Docker images are pushed to Docker Hub.
...
First, [log in to Atlas](https://auth.atlasgo.cloud/signup). If it's your first time, you'll be
...
needing to pull our migration files from source control. For the sake of this example, let's spin up a local database
