...
prompted to create both an account and an organization.
...
In this short tutorial we learned how to use `atlas` to generate migrations, push them to Atlas Cloud and apply them to
