...
directory to Atlas, and applying changes to databases. For a more in-depth guides, please check out the other pages in
...
In this guide, we will use an SQL schema to define our desired state.

First, let's create a simple SQL schema containing 2 tables: `users` and `repos` and name it `schema.sql`:
...
was applied. Here's an example of what it looks like:

<div style={{textAlign: 'center'}}>
    <img src="https://atlasgo.io/uploads/versioned/migrate-target-1.jpg" alt="atlas migrate apply" width="100%"/>
...
<div style={{textAlign: 'center'}}>
    <img src="https://atlasgo.io/uploads/versioned/migrate-deployment-1.jpg" alt="atlas migrate apply" width="100%"/>
...
<div style={{textAlign: 'center'}}>
    <img src="https://atlasgo.io/uploads/versioned/atlas-push-2.jpg" alt="atlas migrate push" width="100%"/>
...
migration has been pushed but not yet applied to it.

<div style={{textAlign: 'center'}}>
    <img src="https://atlasgo.io/uploads/versioned/migrate-target-pending.jpg" alt="atlas migrate push" width="100%"/>
    <p style={{fontSize: 12}}>Database schema <code>public</code> is in <i>Pending</i> mode</p>
</div>

Let's apply our latest migration and then check our database again:
...
<div style={{textAlign: 'center'}}>
    <img src="https://atlasgo.io/uploads/versioned/migrate-target-in-sync.jpg" alt="atlas migrate push" width="100%"/>
    <p style={{fontSize: 12}}>Database schema <code>public</code> is in <i>In Sync</i> mode</p>
</div>

### Next Steps

In this short tutorial we learned how to use `atlas` to generate migrations, push them to Atlas and apply them to
databases. For a more in-depth guides, please check out the other pages in this section or visit our [Guides](/guides) section.
