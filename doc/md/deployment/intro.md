...
:::info
This document pertains to [Atlas v0.3.7](https://github.com/ariga/atlas/releases/tag/v0.3.7) or earlier. Check out the
new and improved UI in [Atlas Cloud](https://atlasgo.cloud).
:::
