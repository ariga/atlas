                        ...
                        <div className="col-lg-6 mb-6 mb-lg-0">
                            <div className="bg-white p-5 rounded-lg shadow">
                                ...
                                <ul className="list-unstyled my-5 text-small text-left">
                                    ...
                                    <li className="mb-3">
                                        <i className="fa fa-check mr-2 text-primary"></i> Backward-compatibility protection
                                    </li>
                                    <li className="mb-3">
                                        <i className="fa fa-check mr-2 text-primary"></i> Destructive change detection
                                    </li>
                                    <li className="mb-3">
                                ...
                                <a href="https://auth.atlasgo.cloud/signup" className="btn btn-primary btn-block p-2 shadow rounded-pill">
                                    Start for free
                                </a>
                            </div>
                        </div>
                        <div className="col-lg-6 mb-6 mb-lg-0">
                            <div className="bg-white p-5 rounded-lg shadow">
                                ...
                                <ul className="list-unstyled my-5 text-small text-left font-weight-normal">
                                    ...
                                    <li className="mb-3">
                                        <i className="fa fa-check mr-2 text-primary"></i> Schema change notifications
                                    </li>
                                    <li className="mb-3">
                                    ...
                                    <li className="mb-3">
                                        <i className="fa fa-check mr-2 text-primary"></i> Drift detection and centralized policies
                                    </li>
                                    <li className="mb-3">
