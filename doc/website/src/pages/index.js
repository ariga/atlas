                ...
                <div className={index.slide1LeftSide}>
                    <div className={index.fullWidthSection}>
                        <h2 className={index.title}
                            style={{color: "#82C7FF"}}>Manage your <br/> database schemas with <span
                            style={{color: "white"}}>Atlas CLI</span></h2>
                    ...
                    <AtlasButton style={{"marginTop": "5%"}} text="Get Started" link="/cli/getting-started/setting-up"
                                 type="primaryButton"/>
                </div>
        ...
        <div className={index.slide2}>
            <div className={index.container}>
                ...
                <section className={index.section} style={{marginTop: "10px"}}>
                    ...
                    <p className={index.paragraphSecondary}
                       style={{color: "#757889"}}>
                        With a single command-line flag, Atlas opens up as a rich user interface to visualize and manage
                        your data topology.
                    </p>
                </section>
        ...
        <div className={index.slide4}>
            <div className={index.container}>
                <section className={index.section}>
                    <h1 className={index.titleSecondary}>Migrate,&nbsp;<span style={{color: "#2064E9"}}>your way.</span>
                    </h1>
                    <p className={index.paragraphSecondary}>Atlas provides the user with two types of migrations -
                        declarative and versioned.</p>
                </section>

                <section className={index.section}>
                    <h2 className={index.subtitle}>Declarative Migrations</h2>
                    <p className={index.paragraphSecondary}>Declarative migrations are migrations in which the user
                        provides the desired state, and Atlas gets your schema there instantly.</p>
                </section>
                ...
                <section className={index.section}>
                    ...
                    <p className={index.paragraphSecondary}>Atlas offers you an alternative workflow, in which
                        migrations are explicitly defined and
