...
* [Pre-migration Checks](#pre-migration-checks): Before migrating your schema, you can now add SQL checks that will be verified to help avoid
risky migrations.
...
* [SQL Server Trigger Support](#sql-server-trigger-support): Atlas now supports managing triggers in SQL Server.
* [ClickHouse Materialized View Support](#clickhouse-materialized-view-support): Atlas now supports managing materialized views in ClickHouse.
