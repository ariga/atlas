...
* [__Pre-migration Checks__](/blog/2024/02/02/atlas-v-0-19#pre-migration-checks): Before migrating your schema, you can now add SQL checks that will be verified to help avoid
risky migrations.
* [__Schema Docs__](/blog/2024/02/02/atlas-v-0-19#schema-docs): Atlas lets you manage your database schema as code. One of the things we love most
...
* [__SQL Server Trigger Support__](/blog/2024/02/02/atlas-v-0-19#sql-server-trigger-support): Atlas now supports managing triggers in SQL Server.
* [__ClickHouse Materialized View Support__](/blog/2024/02/02/atlas-v-0-19#clickhouse-materialized-view-support): Atlas now supports managing materialized views in ClickHouse.
