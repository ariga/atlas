...
authors: a8m
tags: [schema, migration, deployments]
---

import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';

It has been two months since we released the community preview plan for Atlas Cloud, and today I am thrilled to announce
the next batch of features that we are opening from our commercial product to the OSS and our freemium plan.
...
2. Atlas now supports reading the content of the migration directory from cloud accounts once it's synchronized with
   project repository. This eliminates the need for users to build their Docker images with the directory content and
   makes running schema migrations in production much easier.
3. By connecting Atlas CLI to the cloud, migration runs will be logged in the cloud account, making it easier to monitor
   and troubleshoot executed migrations.
4. Slack integration is now available for freemium accounts. Organizations that connect their migration directories to
...
schema migrations. This includes triggering alerts and providing the means to troubleshoot and manage recovery when
problems arise.
...
We have several new features lined up for our freemium plan in the next release. If you're interested in
...
commercial product available to both open-source and freemium plan users.

As always, we value community feedback and strive to be responsive to it. Please feel free to reach out and share your
feedback with me on our [Discord](https://discord.gg/zZ6sWVg6NT) if you think something is missing or could be improved. Cheers!