...
![schema-with-views](https://atlasgo.io/uploads/images/full-schema-with-views.png)
Until recently, the ERD showed schema's tables and the relations between them. With the most recent release,
the ERD now visualizes database views! "Views" are virtual tables created by a query and stored in the database.

![erd-views](https://atlasgo.io/uploads/images/erd-views-two.png)
