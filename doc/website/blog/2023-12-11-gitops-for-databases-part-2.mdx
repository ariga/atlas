...
to extend the native Kubernetes API with new resource types that represent database schemas and migrations.  Using
...
Create a new directory called `manifests` in your GitHub repository with the following contents. In it,
...
spec:
  ...
  dir:
    remote:
      ...
      tag: "1d579be616db48803bb21713fd836a9165030f18"
```
...
Let's now review the flow that we have created, from end to end:
