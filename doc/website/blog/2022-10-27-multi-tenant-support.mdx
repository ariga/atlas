...
architecture because tenants usually expect a decent level of isolation from one another.
...
5. **Migration**: Schema changes can be executed first on _"test tenants"_ and _fail-fast__ in case of error.
