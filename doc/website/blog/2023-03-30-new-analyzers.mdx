...
to have Atlas Cloud pick up a linting configuration file (`atlas.hcl`) from your repository.
...
dropping indexes Postgres will lock the table against writes. Dependent on the size of the data that lock might be in
...
can detect names not compliant to a given naming policy and will warn you in such cases. You can configure both a global
or a resource specific policy. Read on to learn how to configure this analyzer or have a look at the
[documentation](/lint/analyzers#naming-conventions-policy).

## Cloud Linting Configuration

In our last post, [@a8m](https://github.com/a8m) presented the Atlas Cloud community preview and how to connect a
...
and propose to you to use that file on migration linting.

[![](https://user-images.githubusercontent.com/12862103/228925926-56a20694-83a0-407d-884f-b57a7bf4170a.png)](https://auth.atlasgo.cloud/login)
...
and connect an `atlas.hcl` file living in the same repository as your migration files.

TODO - CHANGE IMAGE
[![](https://user-images.githubusercontent.com/12862103/228926214-1c93ce38-f95b-40ab-87bb-5b6598020f35.png)](https://auth.atlasgo.cloud/login)
...
[![](https://user-images.githubusercontent.com/12862103/229103992-eee0ae24-feca-45f1-9e8b-b48859574a08.png)](https://auth.atlasgo.cloud/login)
...
[![](https://user-images.githubusercontent.com/12862103/229107746-db96c538-1fc8-4a0e-a4ad-11655205a98f.png)](https://auth.atlasgo.cloud/login)

## What next?

This is just a small feature we added to Atlas Cloud! In the upcoming weeks, we will be rolling out several new major
